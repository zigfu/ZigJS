...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.goForward = function(autoplay) {
			base.gotoPage(base.currentPage + o.changeBy * (o.playRtl ? -1 : 1), autoplay, o.forwardDoneCallback);
		};

		base.goBack = function(autoplay) {
			base.gotoPage(base.currentPage + o.changeBy * (o.playRtl ? 1 : -1), autoplay, o.backDoneCallback);
		};
	...
	$.anythingSlider.defaults = {
		...
		backDoneCallback	: function(base) {},
		forwardDoneCallback : function(base) {},
